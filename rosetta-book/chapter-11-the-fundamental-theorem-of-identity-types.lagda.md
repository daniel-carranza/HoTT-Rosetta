...
Throughout this book we will encounter many more occasions to characterize identity types.
For example, we will show in Theorem 11.3.1 that the identity type of the natural numbers is equivalent to its observational equality, and we will show in Theorem 22.4.1 that the loop space of the circle is equivalent to `ℤ`.
