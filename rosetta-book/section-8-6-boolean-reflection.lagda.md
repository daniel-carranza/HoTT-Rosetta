...
Moreover, even for computers the task of evaluating a proof term like `is-decidable-is-prime(n)` may quickly get out of hand.
With the formalization of the material in this book, the proof assistant Agda returns a proof term of 430 lines of code when we simply ask it to evaluate the term `is-decidable-is-prime(7)`, and it returned a proof term of 69373 lines of code when we asked it to evaluate the term `is-decidable-is-prime(37)`.
