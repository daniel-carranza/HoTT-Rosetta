...
<!-- rosetta-item: definition-3.2.1; latex-label: defn:addN -->
...
<!-- rosetta-item: subheading-3.2-proof -->

*Construction..* We will construct the binary operation `add-ℕ:ℕ→(ℕ→ℕ)` by induction on the second variable.
...
<!-- rosetta-proof-tree: d21467c0160d; review: pending -->
...
<!-- rosetta-proof-tree: 431d7481f9ea; review: pending -->
...
<!-- rosetta-agda-block: definition-3.2.1-addition-natural-numbers -->
