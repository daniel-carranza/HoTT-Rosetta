...
This rule is the type theoretic version of the induction principle for `ℕ`.
...
<!-- rosetta-item: subheading-3.1-the-formation-rule-of-natural-numbers -->

The type `ℕ` is formed by the **`ℕ`-formation** rule

<!-- rosetta-proof-tree: 20d4900fc763; review: pending -->
...
<!-- rosetta-item: subheading-3.1-the-introduction-rules-of-natural-numbers -->
...
<!-- rosetta-proof-tree: cabcadd3f08b; review: pending -->
...
<!-- rosetta-proof-tree: 932daf70ce52; review: pending -->
...
<!-- rosetta-agda-block: section-3.1-natural-numbers-adapted -->
...
The classical induction principle of the natural numbers tells us what we have to do in order to show that `∀_{(n∈ℕ)}P(n)` holds, for a predicate `P` over `ℕ`.
...
<!-- rosetta-proof-tree: 945981573022; review: pending -->
...
<!-- rosetta-proof-tree: 8fc186621097; review: pending -->
...
<!-- rosetta-proof-tree: 176e12183e5d; review: pending -->
