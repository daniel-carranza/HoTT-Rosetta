...
We say that `f` satisfies the **dependent universal property of the propositional truncation** of `A`, if for any family `Q` of propositions over `P`, the precomposition function
```text
